 ...
 * 
 * <p>
 * (Would be called simply 'Command' if that name wasn't taken by something
 * {@link Command} which could be named 'CommandHandlerBase' instead.)
 * 
 * @author Hugo
 */
public abstract class UserCommand {
	...
	public UserCommand(String originalCommand, String replyTo) {
		this.originalCommand = originalCommand==null?"":originalCommand.trim();
		this.replyTo = replyTo;
	}

	@Deprecated
	public UserCommand(String cmd, String args, String replyTo) {
